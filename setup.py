...
name = 'trytonar_sale_pos_ar'

download_url = 'https://github.com/tryton-ar/sale_pos_ar/tree/%s.%s' % (
...
setup(name=name,
    version=version,
    description='Tryton module that integrates AFIP (Argentina) with sales',
    long_description=read('README'),
    author='tryton-ar',
    url='https://github.com/tryton-ar/sale_pos_ar',
    download_url=download_url,
    package_dir={'trytond.modules.sale_pos_ar': '.'},
    packages=[
        'trytond.modules.sale_pos_ar',
        'trytond.modules.sale_pos_ar.tests',
        ],
    package_data={
    ...
    entry_points="""
    [trytond.modules]
    sale_pos_ar = trytond.modules.sale_pos_ar
    """,
    test_suite='tests',
